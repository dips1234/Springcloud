package com.api.employee.info.swagger;
...
public class Swagger2UiConfiguration  {
    ...
    private ApiInfo metadata() {
        return new ApiInfoBuilder().title("Employee Portal Application").description("API reference guide for developers & testers").termsOfServiceUrl("").contact("").version("1.0").build();  
    }
